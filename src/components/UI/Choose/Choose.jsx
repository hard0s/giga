...
function Choose() {
    return (
        <div className = {cl.chooseDiv}>
            <p className = {cl.chooseDivMainP}>Почему выбирают нас?</p>
            <div className = {cl.chooseDivInner}>
                <div className = {cl.chooseFirstLine}>
                    <p className = {cl.chooseFirstP}>Скидки постоянным клиентам от 5%</p>
                    <div className = {cl.firstDot}></div>
                    <p className = {cl.chooseSecondP}>Предлагаем самые выгодные цены</p>
                    <p className = {cl.chooseThirdP}>Наши покупатели всегда остаются довольны</p>
                    <div className = {cl.secondDot}></div>
                    <p className = {cl.chooseFourthP}>Ширикий ассортимент товаров для всей семьи</p>
                </div>
                <div className = {cl.thirdDot}>
                    <svg className = {cl.thirdDotArrow} xmlns="http://www.w3.org/2000/svg" width="8" height="27" viewBox="0 0 8 27" fill="none"><path d="M4.35355 0.646446C4.15829 0.451185 3.84171 0.451185 3.64645 0.646446L0.464467 3.82843C0.269205 4.02369 0.269205 4.34027 0.464467 4.53553C0.659729 4.7308 0.976312 4.7308 1.17157 4.53553L4 1.70711L6.82843 4.53553C7.02369 4.7308 7.34027 4.7308 7.53553 4.53553C7.7308 4.34027 7.7308 4.02369 7.53553 3.82843L4.35355 0.646446ZM4.5 27L4.5 1L3.5 1L3.5 27L4.5 27Z" fill="#FFFDF5"/></svg>          
                </div>
                <div className = {cl.chooseSecondLine}>
                    <p className = {cl.chooseFifthP}>Возможность доставки в любой город Беларуси </p>
                    <div className = {cl.fourthDot}></div>
                    <p className = {cl.chooseSixthP}>Пункты выдачи заказов рядом с домом</p>
                    <div className = {cl.fifthDot}></div>
                    <div className = {cl.sixthDot}>
                        <svg className = {cl.sixthDotDialog}  xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
